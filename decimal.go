...
//
// The best way to create a new Decimal is to use xdecimal.NewFromString, ex:
//
//	n, err := xdecimal.NewFromString("-123.4567")
...
// Example:
//
//	d1 := xdecimal.NewFromFloat(2).Div(xdecimal.NewFromFloat(3))
//	d1.String() // output: "0.6666666666666667"
//	d2 := xdecimal.NewFromFloat(2).Div(xdecimal.NewFromFloat(30000))
//	d2.String() // output: "0.0000666666666667"
//	d3 := xdecimal.NewFromFloat(20000).Div(xdecimal.NewFromFloat(3))
//	d3.String() // output: "6666.6666666666666667"
//	xdecimal.DivisionPrecision = 3
//	d4 := xdecimal.NewFromFloat(2).Div(xdecimal.NewFromFloat(3))
...
// Zero should never be compared with == or != directly, please use xdecimal.Equal or xdecimal.Cmp instead.
var Zero = New(0, 1)
...
// Example:
//
//	xdecimal.NewFromString("123.456").Truncate(2).String() // "123.45"
